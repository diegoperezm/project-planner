...
export default function App() {
  ...
  const handleChange = (evt) => {
    ...
    let currentDayIndex = tempArr[currentMonthNumber].days
      .map((day) => day.dayNumber)
      .indexOf(parseInt(currentDayNumber));

    // YEAR DAY totalTime
    tempArr[currentMonthNumber].days[currentDayIndex].totalTime = dayTotalTime;

    // YEAR MONTH totalTime
    tempArr[currentMonthNumber].totalTime = monthTotalTime;
